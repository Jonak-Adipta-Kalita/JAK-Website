        ...
        <div>
            <div className="space-y-5">
                <div className="font-salsa text-center">
                    ...
                    <p className="text-[clamp(0.8rem,0.6vw+0.7rem,1.1rem)] sm:text-[1rem] md:text-[clamp(1.2rem,0.8vw+1rem,1.6rem)] text-fg-light tracking-tight sm:tracking-normal xl:mt-5 mt-2 text-center leading-snug">
