...
urlpatterns = [
    ...
    path('my_photos/grant_permission/', views.my_photos_grant_permission, name="grant_permission_for_view_photos"),
    ...
    path("anouncements/poke_go_code/", views.poke_go_code, name="AnouncementPokeGoCodeHome"),
